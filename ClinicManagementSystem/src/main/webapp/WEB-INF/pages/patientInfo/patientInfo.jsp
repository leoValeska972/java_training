    ...
    <div class="form-registration">
      <form:form
        ...
        <div class="center-f">
          <div class="mrg">
            Gender :
            <form:radiobutton path="patientGender" id="male" value="Male" />
            <label for="male">Male</label>
            <form:radiobutton path="patientGender" id="female" value="Female" />
            <label for="female">Female</label> <br> <i class="err-txt"><form:errors
