  ...
  <form:form action="${pageContext.request.contextPath}/addEmployee"
    ...
    <div class="table-responsive">
      ...
      <table class="table table-bordered" style="width: 35%">
        ...
        <tr>
          <td>Name :</td>
          <td><form:input path="ename" required="required" /><br>
            <form:errors path="ename" style="color:red;" /></td>
        </tr>

        <tr>
          <td>Age :</td>
          <td><form:input type="number" path="eage"
              required="required" /><br> <form:errors path="eage"
              style="color:red;" /></td>
        </tr>

        <tr>
          <td>Department :</td>
          <td><form:input path="edept" required="required" /><br>
            <form:errors path="edept" style="color:red;" /></td>
        </tr>
        <tr>
